...
public abstract class PixelNormalizer {
    ...
    /**
     * A PixelNormalizer that applies a scaling factor and equal bias to each pixel channel.
     */

    public static PixelNormalizer PixelNormalizerSingleBias(float scale, float bias) {
    ...
    /**
     * A PixelNormalizer that applies a scaling factor and different biases to each pixel channel.
     */

    public static PixelNormalizer PixelNormalizerPerChannelBias(float scale, float redBias, float greenBias, float blueBias) {
        return new PixelNormalizer() {
            @Override
            public float normalize(int value, int channel) {
                switch (channel) {
