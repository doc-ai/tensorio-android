/*
 * TIOTFLiteStringDataConverter.java
 * TensorIO
 *
...
import ai.doc.tensorio.core.layerinterface.TIODataType;
import ai.doc.tensorio.core.layerinterface.TIOLayerDescription;
import ai.doc.tensorio.core.layerinterface.TIOStringLayerDescription;
import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

public class TIOTFLiteStringDataConverter implements TIOTFLiteDataConverter {
    ...
    public ByteBuffer createBackingBuffer(@NonNull TIOLayerDescription description) {
        ...
        TIODataType dtype = ((TIOStringLayerDescription)description).getDtype();
        int length = ((TIOStringLayerDescription)description).getLength();
    ...
    public ByteBuffer toByteBuffer(@NonNull ByteBuffer byteBuffer, @NonNull TIOLayerDescription description, @Nullable ByteBuffer cache) throws IllegalArgumentException {
        // Create a buffer if no reusable cache is provided
    ...
    public ByteBuffer toByteBuffer(@NonNull FloatBuffer floatBuffer, @NonNull TIOLayerDescription description, @Nullable ByteBuffer cache) throws IllegalArgumentException {
        // Create a buffer if no reusable cache is provided
