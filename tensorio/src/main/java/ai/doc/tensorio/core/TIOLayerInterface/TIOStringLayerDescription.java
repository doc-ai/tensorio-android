...
package ai.doc.tensorio.core.TIOLayerInterface;
...
public class TIOStringLayerDescription extends TIOLayerDescription {
    ...
    public TIOStringLayerDescription(int[] shape, TIODataType dtype) {
        this.shape = shape;
        this.dtype = dtype;
