...
public abstract class PixelDenormalizer {
    ...
    public static PixelDenormalizer TIOPixelDenormalizerSingleBias(float scale, float bias) {
    ...
    public static PixelDenormalizer TIOPixelDenormalizerPerChannelBias(float scale, float redBias, float greenBias, float blueBias) {
        return new PixelDenormalizer() {
            @Override
            public int denormalize(float value, int channel) {
                switch (channel) {
    ...
    public static PixelDenormalizer TIOPixelDenormalizerZeroToOne() {
        float scale = 255.0f;
    ...
    public static PixelDenormalizer TIOPixelDenormalizerNegativeOneToOne() {
