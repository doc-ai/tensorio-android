...
public class TIOModelBundleIntegrationTests {
    ...
    public void testMobileNetModelBundle() {
        ...
        try {
            ...
            Assert.assertSame(input.getMode(), TIOLayerInterface.Mode.Input);

            input.doCase((vectorLayer) -> {
                Assert.fail();
            }, (pixelLayer) -> {
                Assert.assertFalse(pixelLayer.isQuantized());
                Assert.assertSame(pixelLayer.getPixelFormat(), TIOPixelFormat.RGB);
            ...
            Assert.assertSame(output.getMode(), TIOLayerInterface.Mode.Output);
    ...
    public void testMobileNetQuantizedModelBundle() {
        ...
        try {
            TIOModelBundle bundle = new TIOModelBundle(appContext, "mobilenet_v1_1.0_224_quant.tiobundle");
